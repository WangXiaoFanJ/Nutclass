...
public class CropImage {
	...
	private float scale = MediaConst.SCALE_DEFAULT;
	...
	public CropImage(Context context, CropImageView imageView, Handler handler,float scale) {
		mContext = context;
		mImageView = imageView;
		mImageView.setCropImage(this);
		mHandler = handler;
	...
	public void startRotate(float d) {
		...
		showProgressDialog(mContext.getResources().getString(R.string.progress_wait),
				new Runnable() {
					public void run() {
