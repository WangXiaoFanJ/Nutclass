...
public final class DialogUtils {
	...
	public static void showMessageDialog(Context context, int titleResId,
		...
		showMessageDialog(context, getStringFromResource(context, titleResId),
				iconResId, getStringFromResource(context, msgResId),
				positiveId, listener, cancelable);
	}
	...
	public static void showSingleWithoutChoiceItemsDialog(Context context,
			int titleResId, String[] items, int checkedItem,
			ItemSelectedListener listener) {
		showSingleWithoutChoiceItemsDialog(context,
				getStringFromResource(context, titleResId),
				ICON_RES_ID_DEFAULT, items, checkedItem, listener,
	...
	public static void showMultiChoiceDialog(Context context, int titleResId,
			...
			ItemMultiChoiceNonChangedListener negativeListener) {
	...
	public static void showMultiChoiceDialog(Context context, View triggerView,
		...
		showMultiChoiceDialog(context, triggerView, title, ICON_RES_ID_DEFAULT,
				...
				STRING_RES_ID_NULL, negativeListener);
	}
	...
	public static void showMultiChoiceDialog(Context context,
			...
			int negativeId,
			final ItemMultiChoiceNonChangedListener negativeListener) {
		...
		builder.setNegativeButton(
				negativeId == STRING_RES_ID_NULL ? android.R.string.cancel
						: negativeId, new DialogInterface.OnClickListener() {

					@Override
					public void onClick(DialogInterface dialog, int i) {
						if (negativeListener != null) {
							negativeListener.onMutiItemChoiceCancel(dialog,
									triggerView, newCheckedItem);
						}
					}
				});
	 ...
	 *            等待提示内容资源ID
	 */
	public static Dialog showProgressDialog(Context context, int msgResId) {
		return showProgressDialog(context, getStringFromResource(context, msgResId));
	}
	...
	public static Dialog showProgressDialog(Context context, String msg,
			boolean cancelable) {
		return showProgressDialog(context, msg, cancelable, null, null);
	}
...
//				builder.setNeutralButton(buttonResIds[2], onClickListener);
	...
	public interface CheckBoxMessageListener {
		...
		public void onCancel(DialogInterface dialog, boolean checkBoxIsOn);
	}
	...
	public interface ItemMultiChoiceNonChangedListener {
		public void onMutiItemChoiceCancel(DialogInterface dialog,
				View triggerView, boolean[] newCheckedItem);
	}
