...
public class MaterialRefreshLayout extends FrameLayout {
	...
	public void refreshManager(){
		mLayoutManager=mChildView.getLayoutManager();
	}
	@Override
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (dy > 0 && !canChildScrollUp()&&isRefresh) {
...
//
//			} else {
//				flag = ViewCompat.canScrollVertically(mChildView, 1);
//				System.out.println("no absListview flag=" + flag);
//			}
			return true;
		} else {
//			flag = ViewCompat.canScrollVertically(mChildView, 1);
			flag=mChildView.canScrollVertically(1);
			mChildView.getY();
			System.out.println("hight level flag=" + flag + ",y="
					+ mChildView.getY() + ",height=" + mChildView.getHeight()
					+ ",scrolly=" + mChildView.getScrollY() + ",getBottom="
					+ mChildView.getBottom());
			LinearLayoutManager manager=(LinearLayoutManager) mChildView.getLayoutManager();
			System.out.println("manager="+manager.canScrollHorizontally());
		}
	...
	public void finishRefreshing() {
		if (mChildView != null) {
			...
			viewPropertyAnimatorCompat.setDuration(200);
			viewPropertyAnimatorCompat
					.y(ViewCompat.getTranslationY(mChildView));
